"""
Suppose, the questions are divided into 6 categories on the based on their respective difficulties. 
The test will start with a random question from 3rd level(mid-level). 
